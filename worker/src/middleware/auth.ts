...
export async function authMiddleware(
  ...
  try {
    ...
    // La verificación de email se eliminó (no hay proveedor de correo
    // configurado); el tier se basa directamente en el rol. Turnstile en
    // el registro sigue siendo la barrera anti-abuso para altas masivas.
