 ...
 * Sin imports de drizzle ni de lib/tiers — todo inline.
 */
import type { Context, Next } from 'hono'
import type { Env } from '../lib/types'

// Límites inline por tier — sin importar lib/tiers
const LIMITS = {
...
async function inc(kv: KVNamespace, key: string, ttl: number): Promise {
  try {
...
export async function rateLimitMiddleware(
  ...
  try {
    ...
    // Non-fatal — never block a request due to rate limit errors
